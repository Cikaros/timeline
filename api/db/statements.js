...
export const statements = {
  ...
  insertMeeting: 'INSERT INTO meetings (date, note, uid, updated_at) VALUES (?, ?, ?, ?)',
  updateMeetingNote: 'UPDATE meetings SET note = ?, updated_at = ? WHERE id = ?',
  deleteMeeting: 'DELETE FROM meetings WHERE id = ?',
  getIcsMeetings: 'SELECT id, date, note, uid, updated_at FROM meetings WHERE date <= ? ORDER BY date ASC, id ASC',
  getCalDavMeetings: 'SELECT id, date, note, uid, updated_at FROM meetings ORDER BY date ASC, id ASC',
